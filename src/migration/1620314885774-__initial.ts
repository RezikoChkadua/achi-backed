...
export class undefinedinitial1620314885774 implements MigrationInterface {
    name = 'undefinedinitial1620314885774'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "event" ADD "secondAddress" character varying(300) NOT NULL`);
        await queryRunner.query(`ALTER TABLE "event" ADD "secondAddressDeu" character varying(300) NOT NULL`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "event" DROP COLUMN "secondAddressDeu"`);
        await queryRunner.query(`ALTER TABLE "event" DROP COLUMN "secondAddress"`);
